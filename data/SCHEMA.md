...
|-------|------|-------------|-------------|
| `id` | string | minLength: 8 | Unique event identifier — Snowflake format `evt_<snowflake>` (e.g. `evt_52117619469189120`). Generated by `data/scripts/snowflake.js`. |
...
- `id`: present, ≥8 chars, format `evt_<snowflake>` (Snowflake ID) or legacy `evt_YYYYMMDD_NNN`
