# Source Authoring Workflow (Detailed)

This file contains the full encyclopedic walkthrough of the source creation lifecycle. The top-level `SKILL.md` only summarizes phases; this document holds operational detail.
